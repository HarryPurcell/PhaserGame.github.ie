...
//Help
    ...
    this.helpTxt = gameScene.add.text(20, 20, "Help: Tap to avoid the cacti", {
...
//difficulty
    this.diff = 1;
    this.diffTxt = gameScene.add.text(500, 320, "Difficulty: " + this.diff, {
        fontFamily: 'Comic Sans MS',
    fontSize: 22,
    color: '#000',
    align: 'center'
    });
    this.diffTxt.setDepth(5);
...
//move sandfloor along the screen
    ...
    if(this.score % 10 == 0 && this.score != 0){
        this.diff++;
        this.diffTxt.setText("Difficulty: " + this.diff);
        this.gameSpeed += .5;
...
//Camera Shakes, music detunes then stops, game restarts.
    ...
    this.time.delayedCall(1000, function() {    
        let endscreen = this.add.sprite(0,0,'endscreen').setOrigin(0,0).setDepth(2);
